...
If we do want to keep that preference, then the definitions of new ideas should be precise, accurate, and clear, \textit{and} any definition should be offered as tentative, instead of final, open for discussion and destruction, rather than as something immutable. If you take that seriously, then definitions of new ideas aim different things than those of established ideas: the former invite destruction, the latter invite adoption. 


\chapter{How to Facilitate the Writing of Simple Consulting Contracts?}\label{c:case:consulting-contracts}
This is the first of five Chapters which walk you through how actual \ncnf s were designed and revised throughout the innovation process. It illustrates many challenges that arise in doing so.

About a decade ago, when I started doing fieldwork in teams that worked on innovations, I did something they thought was unusual. As soon as we would start working, even when even brainstorming was going into many directions, I insisted on writing down keywords, key terms that popped up in those sessions, and more generally in all team communication, and sending my definitions of these terms to the team, expecting their feedback. Most were surprised, and many saw this as futile, given how fast ideas were changing. And it was true that many terms were thrown away, and that many definitions changed along the way. But I insisted on keeping even a simple list available to all, and asking for all to know it and voice any disagreements at any time.
...
Where I was able to observe the use of such changing terminologies, it became simpler to talk about teams' innovations with interested parties, lawyers, future users, marketers, and any stakeholder group which started interacting with the team over the lifecycle of the innovation.
