...
What were the first new terms that came up, and why? In this case, the challenge that became central was to understand where an invention would make a difference relative to the many established ways in which contracting was being done. Taking a sample of contracting processes which actually did take place, and were thought to reflect common practices, where should we look to make a difference? 
