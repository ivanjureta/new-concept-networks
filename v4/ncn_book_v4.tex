...
''Marketplace'' and \nterm{marketplace} may be the same nouns, but they have significantly different definitions. One  difference is specificity. The definition is now local to the invention we were looking to make. Another difference is the absence to a market independently of the place, which is software in our case, where the supply and demand would meet. Even if ''marketplace'' is certainly no neologism, we did have a meaning for it that was different from a generic one. At the same time, and to the best of our knowledge, there were no comparable marketplaces available, which might include terms defined in a similar way.  
...
\newterm{Companies: Mid-size information technology companies looking for people who are experts in the same technologies, products, services, with real contacts in the markets where the business is interested to establish itself.}
