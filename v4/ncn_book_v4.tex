...
To the extent that each rule restricts the interpretation of a term, it must be part of the definition of that term. If that is the case, then would everything written in the innovation language somehow constitute that language? 

\section{Defining in and with Software Data and Process Models}
...
If you have produced, or even only read requirements models and specifications, conceptual models, entity-relationship models, class diagrams, statecharts, process models (including, but not limited to workflow models, business process models, and many more), this question probably occurred to you by now: How are \ncnf s related to these existing models and the underlying modeling languages? 
