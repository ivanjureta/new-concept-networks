...
Specificity was also clear in definitions of the remaining terms \nterm{company}, \nterm{expert}, \nterm{project}, and \nterm{deal}.

\newterm{Experts: Individuals looking for an efficient way to find work for leading companies they can help the most, and which will pay high rates.}

\newterm{Companies: Mid-size information technology businesses looking for people who are experts in the same technologies, products, services, with real contacts in the markets where the business is interested to establish itself.}
...
The more general, and important point, is that for each definition, we need to break it down and consider individually each term that it mentions. 
...
The terms \nterm{stakeholder} alsow had its own definition in the \ncn. The problem with \nterm{marketplace}, was that it was saying too much about what the software is going to do and who will be using it. As we were deciding what exactly that will be, and how it will work, our commitments about both of these questions became parts of definitions of other terms, which were more specific; eventually, in other words, \nterm{marketplace} became useless because we had more to say about how that marketplace will be working, and whom for. We broke that term down into pieces and defined each piece separately.
